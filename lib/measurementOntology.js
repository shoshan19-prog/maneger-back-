...
export const ONTOLOGY = {
  ph: { domain: 'Chemical', lifecycle: 'Production', phase: 'Wet', standard: 'Internal QC', measurement_type: 'non-destructive', variable_class: 'process', on_deviation: 'adjust_retest_release' },
  density: { domain: 'Physical', lifecycle: 'Production', phase: 'Wet', standard: 'Internal QC', measurement_type: 'non-destructive', variable_class: 'process', on_deviation: 'adjust_retest_release' },
  wet_viscosity: { domain: 'Rheological', lifecycle: 'Production', phase: 'Wet', standard: 'ASTM D2196 / ISO 2555', measurement_type: 'non-destructive', variable_class: 'process', on_deviation: 'adjust_retest_release' },
  ...
  fire_classification: { domain: 'Fire', lifecycle: 'Laboratory', phase: 'Hardened', standard: 'EN 13501-1', measurement_type: 'classification' },
