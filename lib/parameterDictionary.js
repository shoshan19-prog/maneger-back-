...
export const PARAMETERS = [
  ...
  { axis: 'flexural_strength', kind: 'numeric', source_unit: 'MPa', canonical_unit: 'MPa', method: 'flexural_strength_en1015',
    aliases: ['חוזק כפיפה', 'flexural strength', 'flexural'] },
  { axis: 'water_absorption_pct', kind: 'numeric', source_unit: '%', canonical_unit: '%', method: 'water_absorption_en1015',
    aliases: ['ספיגת מים', 'water absorption', 'absorption'] },
  { axis: 'pull_off_adhesion', kind: 'numeric', source_unit: 'MPa', canonical_unit: 'MPa', method: 'EN 1542',
    aliases: ['אדהזיה', 'היצמדות', 'pull off', 'pull-off', 'cross cut', 'cross-cut'] },
  { axis: 'fire_classification', kind: 'qualitative',
    aliases: ['fire classification', 'fire rating', 'reaction to fire', 'סיווג אש', 'דירוג אש'] },
