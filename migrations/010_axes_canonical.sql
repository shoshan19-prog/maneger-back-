...
INSERT INTO axes (axis_id,name,dimension,canonical_unit,method,is_scalar,aliases,direction_of_good,evidence_tier,method_alias,codebook,profile,required_conditions,measurement_protocol) VALUES
  ...
  ('time_to_failure','Time to failure (fire)','time_to_failure','min','heat_to_500C_count_minutes',TRUE,'["ttf","זמן כשל","זמן עמידות אש"]'::jsonb,'higher_is_better','OBSERVED','EN 13381-8 / BS 476 (external standards — NOT the in-house method; kept DISTINCT, not equivalent)','FIRE_DRY(min)',FALSE,NULL,NULL),
